...
<td style="font-size: 90%; padding-left: 10px; padding-right: 5px; background-color: sky;" id="' + description + '"><!--<i class="only-print">__/' + points.toString() + '</i>-->\
  ...
  <tr>\
  <td>\
  <fieldset data-role="controlgroup" data-theme="b" data-type="vertical" style="text-align: center;">\
...
function create3button(mission, points, points2, description) {
  ...
  <tr>\
  <td>\
  <fieldset data-role="controlgroup" data-theme="b" data-type="vertical" style="text-align: center; font-size: 50%;">\
